...
(function attachExponeaForms(global: Window) {
  ...
  function installExponeaForms(exponea: ExponeaLike, options: FormsCoreOptions): ExponeaFormsApi {
    ...
    const api: ExponeaFormsApi = {
      ...
      async show(request, showOptions) {
        ...
        const options: DynamicFormWebLayerOptions = {
          onSubmit(values) {
  ...
  function submitContext(
    options?: ExponeaFormsShowOptions & { request?: FetchFormRequest }
  ): DynamicFormSubmissionContext {
    const request = options?.request;
    const context: DynamicFormSubmissionContext = {
