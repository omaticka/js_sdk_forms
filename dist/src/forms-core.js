...
(function attachDynamicFormsCore(global) {
    ...
    function createFormsCore(options) {
    ...
    function validateField(field) {
        ...
        for (const key of ["id", "name", "type", "title"]) {
            if (!field[key]) {
    ...
    function normalizeValues(definition, values) {
        const normalized = {};
        for (const field of definition.fields) {
    ...
    function validateValues(definition, values) {
        for (const field of definition.fields) {
    ...
    function createSubmitEventProperties(definition, values, context) {
    ...
    function trackingFieldKey(fieldName) {
    ...
    function requiredTracker(tracker) {
